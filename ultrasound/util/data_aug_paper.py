...
img_files = ["test_imgs/000000581630.jpg"]
binary_mask = io.loadmat("/media/data/datasets/Ultrasound/binaryMask.mat")["binaryMask"] 

# Load image
# Bin image to 20-40 bins
# Sample random SOS and density values for each unique bin
# Mask the image
...
def gen_rand(img_files, img_num):
    ...
    for img_idx, img_file in enumerate(img_files):
        ...
        fig.savefig("test_imgs/elephant_gray.png", bbox_inches="tight", pad_inches=0)
        ...
        plt.imshow(img, cmap='gray')
        fig.savefig("test_imgs/elephant_bin.png", bbox_inches="tight", pad_inches=0)
        ...
        print("SOS")
        plt.imshow(img_SOS)
        fig.savefig("test_imgs/elephant_SOS.png", bbox_inches="tight", pad_inches=0)
        #plt.show()
        
        print("DENSITY")
        plt.imshow(img_density)
        fig.savefig("test_imgs/elephant_density.png", bbox_inches="tight", pad_inches=0)
        ...
        plt.imshow(img_SOS)
        fig.savefig("test_imgs/elephant_SOS_masked.png", bbox_inches="tight", pad_inches=0)

        print("IMG DENSITY MASK")
        plt.imshow(img_densities)
        fig.savefig("test_imgs/elephant_density_masked.png", bbox_inches="tight", pad_inches=0)
